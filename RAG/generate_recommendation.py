...
- Do NOT include document names, filenames, page numbers, brackets [], or asterisks/stars (** or *).
...
def generate_offline_grounded_synthesis(
    ...
    to the month name, gap magnitude, and risk level without asterisks or stars.
    """
    month = forecast_result.get("month", "Target Period")
